...
class Crud_penilaian Extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $this->load->view('auditor/penilaian/v_pilih',$data);
...
$data['auditor'] = $this->db->get_where('auth', ['nama'=>$this->session->userdata('nama')])->row_array();
    ...
    $data['dataax'] = $this->m_crud_permintaan->get_permintaan();
     ...
     $this->load->view('auditor/v_header',$data);
    $this->load->view('auditor/v_sidebar',$data);
    $this->load->view('auditor/penilaian/v_pilih2',$data);
    $this->load->view('auditor/v_footer');
  }
  function pilih()
  {
  ...
  function r_penilaian()
  {
    ...
    $this->load->view('auditor/v_header',$data);
    $this->load->view('auditor/v_sidebar',$data);
    $this->load->view('auditor/penilaian/r_penilaian',$data);
    $this->load->view('auditor/v_footer');
  }
  ...
  function v_penilaian()
  {
    ...
    $this->load->view('auditor/v_header',$data);
    $this->load->view('auditor/v_sidebar',$data);
    $this->load->view('auditor/penilaian/v_penilaian',$data);
    $this->load->view('auditor/v_footer');
  }
   ...
   // buat manggil library PDF
    ...
    {   
      ...
      //image1
        ...
        {
            $itung = count($_FILES['berkas']['name']);
            for ($gy=0; $gy < $itung; $gy++) { 
      ...
      //image2
        ...
        {
            $itung = count($_FILES['berkass']['name']);
            for ($yg=0; $yg < $itung; $yg++) { 
            //echo var_dump($itung);die();
        ...
        {
            $itung = count($_FILES['berkasss']['name']);
            for ($y=0; $y < $itung; $y++) 
            { 
            //echo var_dump($itung);die();
      ...
      //end image 3
          ...
          echo"<script>alert('Data berhasil di simpan');location='../../Dashboard'</script>";
