...
class Crud_list_audit Extends CI_Controller{
	...
	function v_list_audit()
	{
        ...
        $this->load->view('admin/list_audit/v_list_audit',$data);
	...
	{	
			...
			$this->m_crud_list_audit->tambah_list_audit($data1,'evaluasi');
					redirect('admin/audit/crud_list_audit/v_list_audit');
	}
	...
	function e_list_audit()
	{
			...
			$this->load->view('admin/v_header',$data);
        	$this->load->view('admin/v_sidebar',$data);
        	$this->load->view('admin/list_audit/e_audit',$data);
        	$this->load->view('admin/v_footer');
	}
	...
	function v_auditw()
	{
		...
		$this->load->view('admin/v_header',$data);
        $this->load->view('admin/v_sidebar',$data);
        $this->load->view('admin/list_audit/v_auditW',$data);
        $this->load->view('admin/v_footer');
	...
	{	
			...
			$this->m_crud_list_audit->tambah_list_audit($data,'periksa');
			$this->m_crud_list_audit->tambah_list_audit($data1,'evaluasi');
					redirect('admin/audit/crud_list_audit/v_auditW');
	}
	...
	function e_auditw()
	{
			...
			$this->load->view('admin/v_header',$data);
        	$this->load->view('admin/v_sidebar',$data);
        	$this->load->view('admin/list_audit/e_auditw',$data);
        	$this->load->view('admin/v_footer');
	}
		...
		function v_auditp()
	{
		...
		$this->load->view('admin/v_header',$data);
        $this->load->view('admin/v_sidebar',$data);
        $this->load->view('admin/list_audit/v_auditp',$data);
        $this->load->view('admin/v_footer');
	...
	{	
			...
			$this->m_crud_list_audit->tambah_list_audit($data,'periksa');
			$this->m_crud_list_audit->tambah_list_audit($data1,'evaluasi');
					redirect('admin/audit/crud_list_audit/v_auditp');
	}
	...
	function e_auditp()
	{
			...
			$this->load->view('admin/v_header',$data);
        	$this->load->view('admin/v_sidebar',$data);
        	$this->load->view('admin/list_audit/e_auditp',$data);
        	$this->load->view('admin/v_footer');
	}
		...
		function v_auditl()
	{
		...
		$this->load->view('admin/v_header',$data);
        $this->load->view('admin/v_sidebar',$data);
        $this->load->view('admin/list_audit/v_auditl',$data);
        $this->load->view('admin/v_footer');
	...
	{	
			...
			$this->m_crud_list_audit->tambah_list_audit($data,'periksa');
			$this->m_crud_list_audit->tambah_list_audit($data1,'evaluasi');
					redirect('admin/audit/crud_list_audit/v_auditl');
	}
		...
		function v_audito()
	{
		...
		$this->load->view('admin/v_header',$data);
        $this->load->view('admin/v_sidebar',$data);
        $this->load->view('admin/list_audit/v_audito',$data);
        $this->load->view('admin/v_footer');
	...
	{	
			...
			$this->m_crud_list_audit->tambah_list_audit($data,'periksa');
			$this->m_crud_list_audit->tambah_list_audit($data1,'evaluasi');
					redirect('admin/audit/crud_list_audit/v_audito');
	}
	...
	function e_audito()
	{
			...
			$this->load->view('admin/v_header',$data);
        	$this->load->view('admin/v_sidebar',$data);
        	$this->load->view('admin/list_audit/e_audito',$data);
        	$this->load->view('admin/v_footer');
	}
