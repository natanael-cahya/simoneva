...
class Crud_rencana Extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('admin/rencana/tb_rencana',$data);
    ...
    function tmbah_rencana()
    {
		...
		$foto=$this->tmbh_rencana();
			...
			$this->m_crud_rencana->tambah_rencana($data,'plannreal');
					redirect('admin/rencana/crud_rencana/v_rencana');
	...
	function e_rencana()
	{
		...
		$this->load->view('admin/v_header',$data);
		$this->load->view('admin/v_sidebar',$data);
		$this->load->view('admin/rencana/e_rencana',$data);
		$this->load->view('admin/v_footer');
	}
	function up_rencana()
	{
	...
	function v_rencana()
	{
		...
		$this->load->view('admin/v_header',$data);
		$this->load->view('admin/v_sidebar',$data);
		$this->load->view('admin/rencana/v_rencana',$data);
		$this->load->view('admin/v_footer');
	}
	function r_rencana()
	{
		...
		$this->load->view('admin/v_header',$data);
		$this->load->view('admin/v_sidebar',$data);
		$this->load->view('admin/rencana/r_rencana',$data);
		$this->load->view('admin/v_footer');
	}
}