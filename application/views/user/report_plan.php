...
<body>
	<table border="1" width="103%" style="margin-left: -27px;margin-top: -25px;">
		<tr style="height: 100px;">
			<td style="height: 80px;width: 230px;"><img src="<?= base_url('img');?>/PJB_LOGO.jpg" width="80px" style="text-align: center;margin-left: 20px;margin-top: -6px;"><img src="<?= base_url('img');?>/logokop.jpg" width="60px" style="text-align: center;margin-left: 50px;margin-top: 10px;"></td>
			<?php foreach($plan as $op){$bd=$op->nama_bidang; ?>
			<td style="text-align: center;font-size: 25pt;">PROGRAM KERJA <?= $bd; ?></td>
		<?php }?>
			<td style="text-align: center;font-size: 25pt;width: 230px;"><?= date('Y') ?></td>
		</tr>
	</table><br/>
