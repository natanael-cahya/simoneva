                  ...
                  ?>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-outline-primary" data-target="#exampleModalz" data-toggle="modalz" href="<?= base_url('admin/audit/crud_list_audit/e_audito/') . $pr->id_periksa ?>">Edit</a>
                          <a class="btn btn-outline-danger" href="<?= base_url('admin/audit/crud_list_audit/h_audito/') . $pr->id_periksa ?>">Delete</a>
                        </td>
