                  ...
                  <div class="card">
                    ...
                    <form class="forms-sample" method="post" action="<?= base_url('admin/audit/crud_auditE/tb_auditE'); ?>">
                       <div class="form-group">
                        bidang<input type="text" name="bdg" value="<?= $kd_bidang ?>">kategori<input type="text" name="kate" value="<?= $kd_kategori ?>">Area<input type="text" value="<?= $kd_area ?>" name="are">
                      </div>
                       <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-xs-12">
                          <input type="file" class="form-control file-upload-info" name="bef" disabled placeholder="Upload Foto">
                        </div>
                      </div>
