      ...
      <div class="content-wrapper">
          ...
          <div class="page-header">
              <h3 class="page-title">
                  ...
                  </span> POB 5S (Landing Page)
              </h3>
              <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a href="#">Pengaturan LP</a></li>
                      <li class="breadcrumb-item active" aria-current="page">POB 5S </li>
                  </ol>
              </nav>
          </div>
                                      ...
                                      <table class="table table-hover table-bordered" id="tablekaarea">
                                          ...
                                          <tbody> <?php
                                                  ...
                                                  <tr>
                                                      <td><?= $i; ?></td>
                                                      <td>
                                                          <a href="<?= base_url('upload_file/pob/' . $p->berkas); ?>">
                                                              <span class="btn btn-primary"><?= $p->berkas ?> </span>
                                                          </a>
                                                      </td>
                                                      ...
                                                      <td>
                                                          <div class="row">
                                                              <div class="col text-center">
                                                                  <a class="btn btn-outline-danger" href="<?= base_url('admin/lp/pob/h_pob/') . $p->id_pob ?>"><i class="mdi mdi mdi-delete"></i> Delete</a>
                                                              </div>
                                                          </div>
                                                      </td>
                                  ...
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          <div class="modal-header">
                                              <h5 class="modal-title" id="exampleModalLabel">FORM POB S5</h5>
                                          ...
                                          <div class="modal-body">
                                              <div class="card">
                                                  <div class="card-body">
                                                      ...
                                                      <form method="post" enctype="multipart/form-data" action="<?= base_url('index.php/admin/lp/pob/tmbah_pob'); ?>">
