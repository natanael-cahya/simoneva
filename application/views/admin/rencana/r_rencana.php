                                      ...
                                      <?php
                                        ...
                                        ?>
                                          <tr>
                                              ...
                                              <td>
                                                  <a class="image-popup-vertical-fit" href="<?= base_url('upload_img/plannreal/' . $d->before_img); ?>">
                                                      <img class="" data-toggle="tooltip" data-placement="top" title="Klik untuk memperbesar Gambar" src="<?= base_url('upload_img/plannreal/' . $d->before_img); ?>" style="border-radius: 0% !important; height: 100px; width: 200px;">
                                                  </a>
                                              </td>
                                              <td>
                                                  <a class="image-popup-vertical-fit" href="<?= base_url('upload_img/plannreal/' . $d->after_img); ?>">
                                                      <img class="" data-toggle="tooltip" data-placement="top" title="Klik untuk memperbesar Gambar" src="<?= base_url('upload_img/plannreal/' . $d->after_img); ?>" style="border-radius: 0% !important; height: 100px; width: 200px;">
                                                  </a>
                                              </td>
                                              <td><?= $d->nama_bidang ?></td>
