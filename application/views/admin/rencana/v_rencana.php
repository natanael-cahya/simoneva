                                          ...
                                          <tr>
                                              ...
                                              <td>
                                                  <a class="image-popup-vertical-fit" href="<?= base_url('upload_img/plannreal/' . $d->before_img); ?>">
                                                      <img class="" data-toggle="tooltip" data-placement="top" title="Klik untuk memperbesar" src="<?= base_url('upload_img/plannreal/' . $d->before_img); ?>" style="border-radius: 0% !important; height: 100px; width: 200px;">
                                                  </a>
