    ...
    <div class="content-wrapper">
      ...
      <div class="page-header">
        <h3 class="page-title">
          ...
          </span> Check List Audit Area Gudang
        </h3>
                ...
                <table class="table table-bordered " id="tableaudit1">
                  <thead class="text-white" style="background-color: #82b3e2; ">
                    ...
                    <tr>
                      ...
                      <th>Kategori S5</th>
                      <th>Audit List</th>
                      <th>Deskripsi Audit | <button class="btn btn-sm btn-success text-white myBtn1">
                          <i class="mdi mdi-eye"></i> Lihat Deskripsi</button>

                        <button class="btn btn-sm btn-success text-white myBtn2 more">
                          <i class="mdi mdi-eye-off "></i> Tutup Deskripsi</button>
                      <th>Aksi</th>
                    </tr>
                  </thead>
                  <?php
                  ...
                  ?>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="alert alert-primary" style="word-wrap:break-word;"><span class="isi more"><?= $pr->deskripsi_eva ?></span> <span class="dots1">...</span></div>

                        </td>

                        <td>
                          <a class="btn btn-outline-primary" data-target="#exampleModalz" data-toggle="modalz" href="<?= base_url('admin/audit/crud_list_audit/e_list_audit/') . $pr->id_periksa ?>">Edit</a>
                          <a class="btn btn-outline-danger" href="<?= base_url('admin/audit/crud_list_audit/h_list_audit/') . $pr->id_periksa ?>">Delete</a>
                        </td>
                ...
                <table class="table table-bordered " id="tableaudit2">
                  <thead class="text-white" style="background-color: #e5b8b7;">
                    ...
                    <tr>
                      ...
                      <th>Kategori S5</th>
                      <th>Audit List</th>
                      <th>Deskripsi Audit | <button class="btn btn-sm btn-success text-white myBtn3">
                          <i class="mdi mdi-eye"></i> Lihat Deskripsi</button>

                        <button class="btn btn-sm btn-success text-white myBtn4 more">
                          <i class="mdi mdi-eye-off "></i> Tutup Deskripsi</button>
                  ...
                  <tbody>
                    <tr>
                      ...
                      ?>
                        ...
                        <td><?= $pr->kat_deskripsi ?></td>
                        <td class="">
                          <div class="alert alert-primary" style="word-wrap:break-word;"><span class="isi2 more"><?= $pr->deskripsi_eva ?></span> <span class="dots2">...</span></div>
                ...
                <table class="table table-bordered" id="tableaudit3">
                  <thead class="text-white" style="background-color: #c2d69b;">
                    ...
                    <tr>
                      ...
                      <th>Kategori S5</th>
                      <th>Audit List</th>
                      <th>Deskripsi Audit | <button class="btn btn-sm btn-success text-white myBtn5">
                          <i class="mdi mdi-eye"></i> Lihat Deskripsi</button>

                        <button class="btn btn-sm btn-success text-white myBtn6 more">
                          <i class="mdi mdi-eye-off "></i> Tutup Deskripsi</button>
                      <th class="text-center">Aksi</th>
                    </tr>
                  </thead>
                  ...
                  ?>
                    <tbody>
                      <tr class="odd gradeX">
                        ...
                        <td><?= $pr->kat_deskripsi ?></td>
                        <td class="">
                          <div class="alert alert-primary" style="word-wrap:break-word;"><span class="isi3 more"><?= $pr->deskripsi_eva ?></span> <span class="dots3">...</span></div>
                        </td>
                ...
                <table class="table table-bordered" id="tableaudit4">
                  <thead class="text-white" style="background-color: #92cddc;">
                    ...
                    <tr>
                      ...
                      <th>Kategori S5</th>
                      <th>Audit List</th>
                      <th>Deskripsi Audit | <button class="btn btn-sm btn-success text-white myBtn7">
                          <i class="mdi mdi-eye"></i> Lihat Deskripsi</button>

                        <button class="btn btn-sm btn-success text-white myBtn8 more">
                          <i class="mdi mdi-eye-off "></i> Tutup Deskripsi</button>
                      <th class="text-center">Aksi</th>
                    </tr>
                  </thead>
                  ...
                  ?>
                    <tbody>
                      <tr>
                        ...
                        <td><?= $pr->kat_deskripsi ?></td>
                        <td class="">
                          <div class="alert alert-primary" style="word-wrap:break-word;"><span class="isi4 more"><?= $pr->deskripsi_eva ?></span> <span class="dots4">...</span></div>
                        </td>
                ...
                <table class="table table-bordered " id="tableaudit5">
                  <thead class="text-white" style="background-color: #fabf8f;">
                    ...
                    <tr>
                      ...
                      <th>Kategori S5</th>
                      <th>Audit List</th>
                      <th>Deskripsi Audit | <button class="btn btn-sm btn-success text-white myBtn9">
                          <i class="mdi mdi-eye"></i> Lihat Deskripsi</button>

                        <button class="btn btn-sm btn-success text-white myBtn10 more">
                          <i class="mdi mdi-eye-off "></i> Tutup Deskripsi</button>
                      <th class="text-center">Aksi</th>
                    </tr>
                  </thead>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?= $pr->kat_deskripsi ?></td>
                        <td class="">
                          <div class="alert alert-primary" style="word-wrap:break-word;"><span class="isi5 more"><?= $pr->deskripsi_eva ?></span> <span class="dots5">...</span></div>
                    ...
                    <div class="modal-body">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <form method="post" action="<?= base_url('index.php/admin/audit/crud_list_audit/t_list_audit'); ?>">
